...
export const communityCreateMultipartSchema = z.object({
  fields: z.object({
...
export const communityUpdateMultipartSchema = z.object({
  fields: z.object({
...
const communityPostFileSchema = z.object({
  media: fileField()
}).strict();

const communityPostTypeSchema = z.nativeEnum(PostType);

export const communityPostCreateMultipartSchema = z.object({
  fields: z.object({
...
export const communityPostUpdateMultipartSchema = z.object({
  fields: z.object({
...
export const communityPostTypeParamsSchema = z.object({
...
export const mediaCreateMultipartSchema = z.object({
  fields: z.object({
    title: requiredTrimmedString(2, 160),
...
export const mediaUpdateMultipartSchema = z.object({
  fields: z.object({
    title: optionalTrimmedString(160),
    type: optionalTrimmedString(50),
    mimeType: optionalTrimmedString(100),
...
const couponFileSchema = z.object({
  image: fileField()
}).strict();
...
export const couponCreateMultipartSchema = z.object({
  fields: z.object({
...
export const couponUpdateMultipartSchema = z.object({
  fields: z.object({
...
export const couponProcessSchema = z.object({
...
export const communityCommentPostParamsSchema = z.object({
  postId: positiveIntSchema
}).strict();

export const dailyTipIdParamsSchema = z.object({
  id: positiveIntSchema
}).strict();

export const dailyTipCreateMultipartSchema = z.object({
  fields: z.object({
...
export const dailyTipUpdateMultipartSchema = z.object({
  fields: z.object({
...
export const conceiveCreateMultipartSchema = z.object({
  fields: z.object({
...
export const conceiveUpdateMultipartSchema = z.object({
  fields: z.object({
...
export const conceiveIdParamsSchema = z.object({
  id: positiveIntSchema
}).strict();

export const conceiveTypeParamsSchema = z.object({
...
export const expertPostIdParamsSchema = z.object({
  id: positiveIntSchema
}).strict();

export const expertPostShareParamsSchema = z.object({
  postId: positiveIntSchema
}).strict();

export const expertProfessionParamsSchema = z.object({
  professionId: positiveIntSchema
}).strict();

export const expertPostCreateMultipartSchema = z.object({
  fields: z.object({
    title: requiredTrimmedString(1, 255),
...
export const expertPostUpdateMultipartSchema = z.object({
  fields: z.object({
    title: optionalTrimmedString(255),
    content: optionalTrimmedString(10000),
...
export const healthSymptomsSchema = z.object({
...
export const loginLogParamsSchema = z.object({
  userId: positiveIntSchema
}).strict();

export const subscriptionUuidParamsSchema = z.object({
  uuid: z.string().trim().min(2).max(64)
}).strict();

export const subscriptionIdsParamsSchema = z.object({
...
export const subscriptionAllocationCreateSchema = z.object({
...
export const subscriptionAllotmentSchema = z.object({
...
export const subscriptionConfirmPaymentSchema = z.object({
  razorpay_order_id: z.string().trim().min(1),
  razorpay_payment_id: z.string().trim().min(1),
  razorpay_signature: z.string().trim().min(1)
}).strict();

export const uploadTableQuerySchema = z.object({
...
export const entityBodySchema = z.object({
  ...
  description: z.union([optionalTrimmedString(5000), z.literal('')]).optional(),
...
export const courseUuidParamsSchema = z.object({
  uuid: z.string().trim().min(2).max(64)
}).strict();

export const courseLessonUuidParamsSchema = z.object({
...
export const courseIdsParamsSchema = z.object({
  ids: z.string().trim().min(1)
}).strict();

export const courseLessonQuerySchema = z.object({
  page: z.coerce.number().int().positive().default(1),
...
export const courseLessonBodySchema = z.object({
  title: optionalTrimmedString(255),
  description: optionalTrimmedString(5000),
  mediaResourceId: positiveIntSchema.optional()
}).strict();

export const courseLessonMediaBodySchema = z.object({
...
export const courseUpdateBodySchema = courseCreateBodySchema.refine((data) => {
  return Object.values(data).some((value) => value !== undefined);
}, { message: 'At least one field is required' });

export const dietToolIdParamsSchema = z.object({
  id: positiveIntSchema
}).strict();

export const dietChartMultipartSchema = z.object({
  fields: z.object({
...
export const dietNuskheMultipartSchema = z.object({
  fields: z.object({
    creator: optionalTrimmedString(255),
    category: optionalTrimmedString(255),
    heading: optionalTrimmedString(255),
...
export const weekBodySchema = z.object({
  name: requiredTrimmedString(1, 255),
